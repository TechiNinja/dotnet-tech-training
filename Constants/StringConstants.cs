namespace SportsManagementApp.StringConstants
{
    public static class AppConstants
    {
        ...
        public const string TeamsGenerated        = "Teams generated successfully.";
        ...
        public const string TeamsDeleted          = "Teams deleted successfully.";
        public const string ScheduleUpdated       = "Match schedule updated successfully.";
        public const string SchedulePublished     = "Schedule published and locked successfully.";
        ...
        public const string WinnerIdRequired             = "WinnerId is required.";
        ...
        public const string NoFixturesToPublish = "No fixtures found for this category. Generate fixtures before publishing.";
        public const string TagFixtures = "Fixtures";
        public const string ScheduleAlreadyPublished = "Schedule is already published for this category.";
        ...
        public const string CategoryNotForDoubles   = "Team generation is only available for Doubles format categories.";
        public const string CategoryScheduleLocked  = "Schedule is already published and locked for this category.";
        public const string TeamNotFound            = "Team #{0} not found.";
        public const string TeamNotInCategory       = "Team #{0} does not belong to category #{1}.";
        public const string NotEnoughRegistrations  = "At least 2 registrations are required to generate teams. Current count: {0}.";
        ...
        public const string TeamsAlreadyExist       = "Teams already exist for this category. Delete existing teams first.";
        ...
        public const string NoSetsSubmitted = "Cannot submit result with no sets. Submit set scores first.";
        ...
        public const string ScheduleNotPublishable  = "All matches must be scheduled before publishing.";
